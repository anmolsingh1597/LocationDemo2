...
//        permissions.add(Manifest.permission.ACCESS_FINE_LOCATION);
    ...
    protected void onPostResume() {
        super.onPostResume();
        // this is a proper place to check for the google play services availabilty
            ...
            Dialog errorDialog = GoogleApiAvailability.getInstance()
                    .getErrorDialog(this,errorCode, errorCode,new DialogInterface.OnCancelListener() {
                        ...
                        public void onCancel(DialogInterface dialog) {
                            Toast.makeText(MainActivity.this, "No Google Play Api Services", Toast.LENGTH_SHORT).show();
                        }
                    });
            errorDialog.show();
        } else {
